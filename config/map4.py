...
from config.scenario.robot_start_pos_init_2D import robot_init_2d
...
dim = 2
dt = 0.1
ws = np.array([[-6, 6], [-6, 6]])       # [[x1, x2], [y1, y2]]
...
n_robot = 10     # mode
n_obs = 0       # here we only have the 0, 1, 3 num of the circle obs
...
ROBOT_DATABASE = {
    ...
    'robots_config': robot_init_2d(n_robot)
}
